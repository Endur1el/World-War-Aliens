...
public class Example : MonoBehaviour {
	...
	public Vector3 debugWireSpherePosition;
	...
	{	
		...
		if(debugCircle) DebugExtension.DrawCircle(debugCircle_Up, debugCircle_Color, debugCircle_Radius);
		if(debugWireSphere)
		{
			Gizmos.color = debugWireSphere_Color;
			Gizmos.DrawWireSphere(debugWireSpherePosition, debugWireSphere_Radius);
		}
